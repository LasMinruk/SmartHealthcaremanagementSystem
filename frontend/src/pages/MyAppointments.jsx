                    ...
                    <div key={index} className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-4 border-b'>
                        ...
                        <div className='flex gap-2'>
                            {!item.cancelled && item.payment && !item.isCompleted && (
                                <button onClick={() => navigate(`/video/${item._id}`)} className='text-[#696969] px-4 py-2 border rounded hover:bg-primary hover:text-white transition-all duration-300'>Join Video</button>
                            )}
                        </div>
