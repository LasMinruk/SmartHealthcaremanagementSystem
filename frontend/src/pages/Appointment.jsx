    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 border border-[#ADADAD] rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
          ...
          <p className="flex items-center gap-2 text-3xl font-medium text-gray-700">
            ...
            {docInfo.type === "Government" && (
              <span className="text-sm px-3 py-1 bg-green-100 text-green-600 rounded-full font-normal">
                Government
              </span>
            )}
          </p>
          ...
          {/* Show appointment fee only for private doctors */}
          {docInfo.type === "Private" && docInfo.fees && (
      ...
      <div className="sm:ml-72 sm:pl-4 mt-8 font-medium text-[#565656]">
            ...
            docSlots[slotIndex].map((item, index) => (
              <p
                ...
                className={`text-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer transition-all ${
                  item.time === slotTime
                    ? "bg-primary text-white"
                    : "text-[#949494] border border-[#B4B4B4] hover:border-primary"
                }`}
              >
        ...
        <button
          ...
          disabled={!slotTime}
          className={`text-white text-sm font-light px-20 py-3 rounded-full my-6 transition-all ${
            slotTime
